        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('seller.snacks.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="price" id="price" step="0.01" class="form-input mt-1 block w-full @error('price') border-red-500 @enderror text-black" value="{{ old('price') }}" required>
                            @error('price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
